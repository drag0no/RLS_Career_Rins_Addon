...
local function buildCareerActions(context, registerButton)
  ...
  -- Progress / skill trees (was dead code after Vue pause migration)
  addCareerPathsAction(actions, registerButton)
  addCareerMilestonesAction(actions, registerButton)

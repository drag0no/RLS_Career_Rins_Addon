  ...
  },
  {
    ...
    sections: [
      ...
      },
      {
        ...
        body: [
          'From WCARA (League 2) onward you can hire drivers on the "Drivers" tab, assign a fleet car, and book sanctioned races they run while you spectate. Higher-tier drivers race faster, brake later, and pass more aggressively.',
          ...
          'After a short countdown the race is ready. Open "Scheduled Races" and tap "Spectate" to watch your driver\'s run, or "Drop out" to cancel the booking.',
          'Fleet cars and drivers both need recovery cooldowns between races — the "Reduced Cooldown" skill shortens them.',
          '"Manager" automation (Team Ops skill) toggles "Auto-assign sanctioned offers" on the "Race" tab to book idle drivers on a timer.',
          '"Shop App" enables phone alerts when a booked race is ready to spectate.',
        ],
      },
      {
        ...
        body: [
          ...
          'Spend team skill XP in three trees: Team Ops (laptop, phone app, pit fuel, manager), QOL (dyno, garage slots, towing, quick travel), and Driver (expanded roster, cooldown reduction, podium analytics).',

    ...
    sections: [
      ...
      },
      {
        ...
        body: [
          ...
          'Podium finishers undergo scrutineering at Parc Fermé. Exceeding class power-to-weight limits results in technical disqualification. Under-spec vehicles are never penalized — underdog victories are fully recognized and rewarded.',
        ],
      },
    ],
  },
    ...
    sections: [
      ...
      },
      {
        ...
        body: [
          ...
          'All fleet vehicles require an official [Dyno Certified] badge to enter sanctioned races. Teams with the "Dyno" workshop skill certify newly bought cars and modifications instantly and for free. Without the workshop dyno, vehicles can be sent for third-party assessment ($1,200, 5-minute timer) on the "Vehicles" tab. Any part installation or tuning change clears certification, requiring re-assessment.',
          'Podium finishers undergo scrutineering at Parc Fermé. Exceeding class bracket power ceilings results in disqualification. Lower-tier underdog vehicles entering higher classes are welcomed and never penalized — underdog podium finishes receive full prize money, XP, and trophies.',
      ...
      },
      {
        ...
        body: [
          ...
          'Accepted races appear under "Scheduled Races" on the "Race" tab and the "Home" dashboard. You can tap "Drive to Track" to stage at the grid, or "Drop out" to cancel your booking and receive a full entry-fee refund.',
      ...
      },
      {
        ...
        body: [
          'From WCARA (League 2) onward you can hire drivers on the "Drivers" tab, assign a fleet car, and book sanctioned races they run while you spectate or explore. Higher-tier drivers race faster, brake later, and pass more aggressively.',
          'On "Available Races", pick an offer and choose "Assign driver", or "Race myself" to drive personally. Driving yourself awards 85% of the prize purse (15% goes to your pit crew) and incurs a 15-minute driver cooldown.',
          'After a short countdown the race is ready. Open "Scheduled Races" and tap "Manage myself" to spectate in 3D, "Send with Manager" to resolve the race in the background, or "Drop out" to cancel the booking.',
      ...
      },
      {
        ...
        body: [
          'Team money is separate from your wallet. Race payouts, entry fees, driver cuts, operating costs, paint, fuel, and league registration all flow through the team account on "Finances".',
          'Hired drivers take a 15% to 35% cut of gross race winnings based on experience tier. Driving yourself pays an 85% net purse with a flat 15% pit crew share.',

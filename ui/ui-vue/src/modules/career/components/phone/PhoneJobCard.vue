    ...
    <div class="card-content">
      ...
      <div class="info-container">
        ...
        <div class="goal-section">
          ...
          <div v-if="isActive && completionBlockedMessage" class="completion-warning-row build-changed-warning">
...
watch(() => [props.isActive, props.job.currentTime, props.job.goalTime, props.job.jobId, props.job.completionBlockedMessage, props.job.buildChanged], checkCanComplete)

                      ...
                      <div class="can-afford-toggle" :class="{ active: canAfford }">
                        <label>
                          ...
                          <span class="toggle-label">
                            ...
                            <span class="afford-text">{{ racingTeamVehicleShop ? "Team budget" : "Can afford" }}</span>
                            <span class="money-amount">${{ formatNumber(filterBudgetMoney) }}</span>
                          </span>
                        </label>
                      </div>
                    </div>
...
// Personal wallet from store (nil in payload during racing-team shop; filter row uses filterBudgetMoney there).
...
const filterBudgetMoney = computed(() => {
  if (racingTeamVehicleShop.value) {
    const v = vehicleShoppingStore?.vehicleShoppingData?.racingTeamBusinessMoney
...
const effectivePriceBounds = computed(() => {
  ...
  const cap = Math.max(priceBounds.value.min, Math.min(filterBudgetMoney.value, baseMax))
...
watch([canAfford, playerMoney, filterBudgetMoney, priceBounds], () => {
